...
describe("Application", () => {
  it("defaults to Monday and changes the scheduler when a new day is selected", async () => {
  ...
  it("shows the delete error when failing to delete an exisiting appointment", async () => {
    const { container } = render(<Application />);
